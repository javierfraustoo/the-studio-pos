...
const styles: Record<string, React.CSSProperties> = {
  page: { height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'var(--bg-primary)', fontFamily: "'Inter', system-ui, sans-serif" },
  ...
  title: { fontSize: 22, fontWeight: 800, color: 'var(--text-primary)', margin: 0, letterSpacing: 1 },
  badge: { fontSize: 11, fontWeight: 700, backgroundColor: '#10B981', color: 'var(--text-primary)', padding: '3px 8px', borderRadius: 4 },
  subtitle: { fontSize: 14, color: 'var(--text-muted)', margin: '0 0 24px' },
  userGrid: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 },
  userBtn: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: 20, borderRadius: 16, border: '1px solid rgba(255,255,255,0.06)', backgroundColor: 'var(--bg-card)', cursor: 'pointer', transition: 'all 0.15s' },
  userAvatar: { width: 48, height: 48, borderRadius: 24, color: 'var(--text-primary)', fontSize: 22, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  userName: { fontSize: 14, fontWeight: 700, color: 'var(--text-primary)' },
  userRole: { fontSize: 11, fontWeight: 600 },
  backBtn: { background: 'none', border: 'none', fontSize: 14, color: 'var(--text-muted)', cursor: 'pointer', fontWeight: 600, marginBottom: 16, padding: 0 },
  pinTitle: { fontSize: 20, fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 4px' },
  ...
  loading: { color: 'var(--text-muted)', fontSize: 13, margin: '0 0 8px' },
  numpad: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, maxWidth: 280, margin: '0 auto' },
  numKey: { height: 64, borderRadius: 16, border: '1px solid rgba(255,255,255,0.06)', backgroundColor: 'var(--bg-card)', fontSize: 24, fontWeight: 700, cursor: 'pointer', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.1s' },
};
