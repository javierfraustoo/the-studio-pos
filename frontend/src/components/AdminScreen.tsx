...
const S: Record<string, React.CSSProperties> = {
  ...
  tab: { padding: '8px 16px', borderRadius: 8, border: 'none', cursor: 'pointer', fontWeight: 600, fontSize: 13 },
  tabActive: { backgroundColor: 'var(--accent)', color: 'var(--accent-text)' },
  tabInactive: { backgroundColor: 'var(--bg-hover)', color: 'var(--text-secondary)' },
  card: { backgroundColor: 'var(--bg-card)', borderRadius: 12, border: '1px solid var(--border)', padding: 20, marginBottom: 16 },
